  ...
  KeyEventResult _handleKeyEvent(FocusNode node, KeyEvent event) {
    if (event is KeyDownEvent) {
      if (event.logicalKey == LogicalKeyboardKey.arrowUp) {
        int newHour = (widget.selectedTime.hour - 1 + 24) % 24;
        widget.onTimeChange(TimeOfDay(hour: newHour, minute: 0));
        return KeyEventResult.handled;
      } else if (event.logicalKey == LogicalKeyboardKey.arrowDown) {
        int newHour = (widget.selectedTime.hour + 1) % 24;
        widget.onTimeChange(TimeOfDay(hour: newHour, minute: 0));
        return KeyEventResult.handled;
      }
    }
                          ...
                          child: GestureDetector(
                            ...
                            onVerticalDragUpdate: (DragUpdateDetails details) {
                              ...
                              int touchedIndex = (details.localPosition.dy /
                                  ...
                                  .clamp(0, 23);
                              int newSelectedHour =
                                  displayHoursOrder[touchedIndex];
                              ...
                              children: [
                                for (var hourValue in displayHoursOrder)
                                  SizedBox(
                                    ...
                                    width:
                                        45, // Match the slightly wider width here
                                    child: Container(
